export function maskPII(text: string): { masked: string; detected: boolean } {
  ...
  // JWT Tokens (before Bearer, more specific)
  ...
  // Credentials embedded in URLs (e.g. postgres://user:pass@host)
  ...
  // password/secret/token key=value pairs in logs or query strings
  ...
  // Crypto Wallet Addresses (Ethereum, Bitcoin legacy + bech32)
